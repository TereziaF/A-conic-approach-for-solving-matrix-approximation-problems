function[X,hodnost,hodnost_final,g,g_final,norma,norm_final,cas,t,s,empirical_epsilon,t_var,S,V,G] = logdet_bicri_L1_OBLIQUE(X0,V0,C,A,B,W,k,epsilon,M,alpha)
