...
[X_hat,hodnost_hat_LOG,g_hat_LOG,norma_hat_LOG,gamma,hodnost,iter_LOG,cas,hodnost_final_LOG_MOD,g_final_LOG_MOD,norm_final_LOG_MOD,cas_LOG_MOD,t_LOG_MOD,s_LOG_MOD,empirical_epsilon_LOG_MOD] = bisection_logdet_L1_OBLIQUE(t_rel,g_final_LOG_bicri,X_rel,X_LOG_bicri,V_rel,V_LOG_bicri,C,A,B,W,m,epsilon,M);
...
[X_hat,hodnost_hat_CI,g_hat_CI,norma_hat_CI,gamma,hodnost,iter_CI,cas,hodnost_final_CI_MOD,g_final_CI_MOD,norm_final_CI_MOD,cas_CI_MOD,t_CI_MOD,s_CI_MOD,empirical_epsilon_CI_MOD] = bisection_CI_L1_OBLIQUE(t_rel,g_final_CI_bicri,X_rel,X_CI_bicri,V_rel,V_CI_bicri,C,A,B,W,m,epsilon,M);
...
gamma = t_rel;
[X_LOG_MOD,hodnost_LOG_MOD,hodnost_final_LOG_MOD,g_LOG_MOD,g_final_LOG_MOD,norma_LOG_MOD,norm_final_LOG_MOD,cas_LOG_MOD,t_LOG_MOD,s_LOG_MOD,empirical_epsilon_LOG_MOD,t_var,S,V,G] = logdet_mod_L1_OBLIQUE(X_rel,V_rel,C,A,B,W,m,tol,maxiter,gamma);
...
[X_CI_MOD,hodnost_CI_MOD,hodnost_final_CI_MOD,g_CI_MOD,g_final_CI_MOD,norma_CI_MOD,norm_final_CI_MOD,cas_CI_MOD,t_CI_MOD,s_CI_MOD,empirical_epsilon_CI_MOD,sum_eig_final_CI_MOD,sum_eig_real_CI_MOD,t_var,S,V,G] = cvx_iter_mod_L1_OBLIQUE(C,A,B,W,m,tol,maxiter,gamma);
...
tabulka = [tabulka;...
   ...
   orth_final_CI_bicri,hodnost_final_CI_bicri,g_final_CI_bicri,norm_final_CI_bicri,cas_CI_bicri,empirical_epsilon_CI_bicri,...
   orth_final_LOG_MOD,hodnost_final_LOG_MOD(end),g_final_LOG_MOD(end),norm_final_LOG_MOD(end),sum(cas_LOG_MOD),mean(empirical_epsilon_LOG_MOD),...
   orth_final_CI_MOD,hodnost_CI_MOD(end),g_final_CI_MOD(end),norm_final_CI_MOD(end),sum(cas_CI_MOD),mean(empirical_epsilon_CI_MOD),...
    orth_hat_LOG_bisection, hodnost_hat_LOG,g_hat_LOG,norma_hat_LOG, iter_LOG, cas_BI_LOG,...
   orth_hat_CI_bisection,hodnost_hat_CI,g_hat_CI,norma_hat_CI, iter_CI, cas_BI_CI];
filename = ['OBLIQUE_L1_weighted_not1_P10N4M4Q3riadok' num2str(opakuj) '.csv'];
