function[X,hodnost,hodnost_final,g,g_final,norma,norm_final,cas,t,s,empirical_epsilon,sum_eig_final,sum_eig_real,t_var,S,V,G] = cvx_iter_mod_L1_OBLIQUE(C,A,B,W,k,epsilon,M,gamma)
...
%inicialize
[X,t_var,S,V,G] = SDPrelax_OBLIQUE_L1(A, B, C, W, m, n, p, q)
U = CI2(V,m,n,k);
...
[X,t_var,S,V] = CI1_mod_L1_OBLIQUE(U,C,A,B,W,m,n,p,q,gamma);
U = CI2(V,m,n,k);
