function[X,hodnost,hodnost_final,g,g_final,norma,norm_final,cas,t,s,empirical_epsilon,sum_eig_final,sum_eig_real,s_var,Y,V,G] = cvx_iter_bicri_OBLIQUE_L2(C,A,B,W,k,epsilon,M,alpha)
...
%inicialize
[X,s_var,Y,V,G] = SDPrelax_OBLIQUE_L2(A, B, C, W, m, n, p, q)
U = CI2(V,m,n,k);
...
[X,s_var,Y,V,G] = CI1_bicri_OBLIQUE_L2(U,C,A,B,W,m,n,p,q,alpha);
U = CI2(V,m,n,k);

hodnost = [hodnost;sum(eig(V)>epsilon)];
sum_eig = [sum_eig;s_var];
g = [g; s_var];
