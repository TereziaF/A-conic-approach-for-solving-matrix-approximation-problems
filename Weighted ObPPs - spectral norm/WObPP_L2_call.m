...
tic;
[X_rel,s_rel,Y_rel,V_rel,G_rel] = SDPrelax_OBLIQUE_L2(A, B, C, W, m, n, p, q);
cas_REL = toc;                                            %time
hodnost_final_REL = sum(eig(V_rel)>epsilon);              %rank
g_final_REL = s_rel;                                      %optimal value of reformulation
norm_final_REL = norm(C-A*X_rel*B,2);                     %optimal value
...
%logdet bicri
alpha = 10;
[X_LOG_bicri,hodnost_LOG_bicri,hodnost_final_LOG_bicri,g_LOG_bicri,g_final_LOG_bicri,norma_LOG_bicri,norm_final_LOG_bicri,cas_LOG_bicri,t_LOG_bicri,s_LOG_bicri,empirical_epsilon_LOG_bicri,s_var_LOG_bicri,Y_LOG_bicri,V_LOG_bicri,G_LOG_bicri] = logdet_bicri_OBLIQUE_L2(X_rel,V_rel,C,A,B,W,m,epsilon,M,alpha);
orth_final_LOG_bicri = norm(diag(X_LOG_bicri'*X_LOG_bicri)-ones(n,1),1);   %oblique criterion
hodnost_final_LOG_bicri                                                    %rank

%convex iter. bicri
alpha = 10;
[X_CI_bicri,hodnost_CI_bicri,hodnost_final_CI_bicri,g_CI_bicri,g_final_CI_bicri,norma_CI_bicri,norm_final_CI_bicri,cas_CI_bicri,t_CI_bicri,s_CI_bicri,empirical_epsilon_CI_bicri,sum_eig_final_CI_bicri,sum_eig_real_CI_bicri,s_CI_bicri,Y_CI_bicri,V_CI_bicri,G_CI_bicri] = cvx_iter_bicri_OBLIQUE_L2(C,A,B,W,m,epsilon,M,alpha);
...
[X_hat,hodnost_hat_LOG,g_hat_LOG,norma_hat_LOG,gamma,hodnost,iter_LOG,cas,hodnost_final_LOG_MOD,g_final_LOG_MOD,norm_final_LOG_MOD,cas_LOG_MOD,t_LOG_MOD,s_LOG_MOD,empirical_epsilon_LOG_MOD] = bisection_logdet_OBLIQUE_L2(s_rel,g_final_LOG_bicri,X_rel,X_LOG_bicri,V_rel,V_LOG_bicri,C,A,B,W,m,epsilon,M);
...
[X_hat,hodnost_hat_CI,g_hat_CI,norma_hat_CI,gamma,hodnost,iter_CI,cas,hodnost_final_CI_MOD,g_final_CI_MOD,norm_final_CI_MOD,cas_CI_MOD,t_CI_MOD,s_CI_MOD,empirical_epsilon_CI_MOD] = bisection_CI_OBLIQUE_L2(s_rel,g_final_CI_bicri,X_rel,X_CI_bicri,V_rel,V_CI_bicri,C,A,B,W,m,epsilon,M);
...
gamma = s_rel;
[X_LOG_MOD,hodnost_LOG_MOD,hodnost_final_LOG_MOD,g_LOG_MOD,g_final_LOG_MOD,norma_LOG_MOD,norm_final_LOG_MOD,cas_LOG_MOD,t_LOG_MOD,s_LOG_MOD,empirical_epsilon_LOG_MOD,s_LOG_MOD,Y_LOG_MOD,V_LOG_MOD,G_LOG_MOD] = logdet_mod_OBLIQUE_L2(X_rel,V_rel,C,A,B,W,m,tol,maxiter,gamma);
...
[X_CI_MOD,hodnost_CI_MOD,hodnost_final_CI_MOD,g_CI_MOD,g_final_CI_MOD,norma_CI_MOD,norm_final_CI_MOD,cas_CI_MOD,t_CI_MOD,s_CI_MOD,empirical_epsilon_CI_MOD,sum_eig_final_CI_MOD,sum_eig_real_CI_MOD,s_CI_MOD,Y_CI_MOD,V_CI_MOD,G_CI_MOD] = cvx_iter_mod_OBLIQUE_L2(C,A,B,W,m,tol,maxiter,gamma);
...
tabulka = [tabulka;...
   ...
   orth_final_CI_MOD,hodnost_final_CI_MOD,g_final_CI_MOD,norm_final_CI_MOD,sum(cas_CI_MOD),mean(empirical_epsilon_CI_MOD),...
    orth_hat_LOG_bisection, hodnost_hat_LOG,g_hat_LOG,norma_hat_LOG, iter_LOG, cas_BI_LOG,...
   orth_hat_CI_bisection,hodnost_hat_CI,g_hat_CI,norma_hat_CI, iter_CI, cas_BI_CI];
filename = ['OBLIQUE_L2_weighted_not0_P10N4M4Q3riadok' num2str(opakuj) '.csv'];
