function[X,hodnost,hodnost_final,g,g_final,norma,norm_final,cas,t,s,empirical_epsilon,sum_eig_final,sum_eig_real,s_var,Y,V,G] = cvx_iter_mod_OBLIQUE_L2(C,A,B,W,k,epsilon,M,alpha)
...
[X,s_var,Y,V,G] = CI1_mod_OBLIQUE_L2(U,C,A,B,W,m,n,p,q,alpha);
U = CI2(V,m,n,k);
