function[X,hodnost,hodnost_final,g,g_final,norma,norm_final,cas,t,s,empirical_epsilon,Z,Y] = corr_logdet(X_0,C,k,epsilon,M)
...
minimize sum(diag(inverzna_matica*X))
