function[X,hodnost,hodnost_final,g,g_final,norma,norm_final,cas,t,s,empirical_epsilon,V,G,Y,Z] = logdet_bicri_OBLIQUE_Frob(X0,V0,C,A,B,W,k,epsilon,M,alpha)
