function[X,hodnost,hodnost_final,g,g_final,norma,norm_final,cas,t,s,empirical_epsilon,sum_eig_final,sum_eig_real,V,G,Y,Z] = cvx_iter_bicri_OBLIQUE_Frob(C,A,B,W,k,epsilon,M,alpha)
...
% Z, Y, V, G - solutions of the reformulated problem
...
[X,V,G,Y,Z] = CI1_bicri_OBLIQUE_Frob(U,C,A,B,W,m,n,p,q,alpha);
U = CI2(V,m,n,k);
