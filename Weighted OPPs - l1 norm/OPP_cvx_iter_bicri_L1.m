function[X,hodnost,hodnost_final,g,g_final,norma,norm_final,cas,t,s,empirical_epsilon,sum_eig_final,sum_eig_real,t_var,S,V] = OPP_cvx_iter_bicri_L1(C,A,B,W,k,epsilon,M,alpha)
...
[X,t_var,S,V] = OPP_CI1_bicri_L1(U,C,A,B,W,m,n,p,q,alpha);
U = OPP_CI2(V,m,n,k);
