function[X,hodnost,hodnost_final,g,g_final,norma,norm_final,cas,t,s,empirical_epsilon,sum_eig_final,sum_eig_real,t_var,S,V,G] = cvx_iter_bicri_Linfty_OBLIQUE(C,A,B,W,k,epsilon,M,alpha)
...
%inicialize
[X,t_var,S,V] = SDPrelax_OBLIQUE_Linfty(A, B, C, W, m, n, p, q)
U = CI2(V,m,n,k);
...
[X,t_var,S,V,G] = CI1_bicri_Linfty_OBLIQUE(U,C,A,B,W,m,n,p,q,alpha);
U = CI2(V,m,n,k);
