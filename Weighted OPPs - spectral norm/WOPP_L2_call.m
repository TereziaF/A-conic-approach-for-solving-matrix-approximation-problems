...
%SDP relaxation
tic;
[X_rel,Y_rel,s_rel,V_rel] = SDPrelax_L2(A, B, C, W, m, n, p, q);
toc;

norm(C-A*X_rel, 2)                         %optimal value
...
alpha = 1;
[X_LOG_bicri,hodnost_LOG_bicri,hodnost_final_LOG_bicri,g_LOG_bicri,g_final_LOG_bicri,norma_LOG_bicri,norm_final_LOG_bicri,cas_LOG_bicri,t_LOG_bicri,s_LOG_bicri,empirical_epsilon_LOG_bicri,s_var_LOG_bicri,Y_LOG_bicri,V_LOG_bicri] = OPP_logdet_bicri_L2(X_rel,V_rel,C,A,B,W,m,tol,maxiter,alpha);
...
gamma = s_rel;
[X_LOG_MOD,hodnost_LOG_MOD,hodnost_final_LOG_MOD,g_LOG_MOD,g_final_LOG_MOD,norma_LOG_MOD,norm_final_LOG_MOD,cas_LOG_MOD,t_LOG_MOD,s_LOG_MOD,empirical_epsilon_LOG_MOD,t_var_LOG_MOD,S_LOG_MOD] = OPP_logdet_mod_L2(X_rel,V_rel,C,A,B,W,m,tol,maxiter,gamma);
...
gamma = s_rel;
[X_CI_MOD,hodnost_CI_MOD,hodnost_final_CI_MOD,g_CI_MOD,g_final_CI_MOD,norma_CI_MOD,norm_final_CI_MOD,cas_CI_MOD,t_CI_MOD,s_CI_MOD,empirical_epsilon_CI_MOD,sum_eig_final_CI_MOD,sum_eig_real_CI_MOD,t_var_CI_MOD,S_CI_MOD] = OPP_cvx_iter_mod_L2(C,A,B,W,m,tol,maxiter,gamma);
